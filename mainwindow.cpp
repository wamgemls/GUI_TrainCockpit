    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(ui->quitbutton, SIGNAL(clicked()), &thread_for_worker, SLOT(quit()));
    ...
    connect(ui->startworker, SIGNAL(clicked()), &worker, SLOT(startWorking()));
    // Stoppen des Workers (Thread läuft aber weiter)
    connect(ui->closeworker, SIGNAL(clicked()), &worker, SLOT(stopWorking()));

    connect(ui->getdata, SIGNAL(clicked()), this, SLOT(getDataFromSharedDataObject()));
